...
export default {
    ...
    computed: {
        prettyPrice() { return this.price.toFixed(2) },
        enrolments() { return 17; },
        activeEnrolments() { return 9; },
        pendingEnrolments() { return this.enrolments - this.activeEnrolments; }
    }
}
</script>